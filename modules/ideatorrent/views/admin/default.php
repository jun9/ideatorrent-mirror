...
<?php if($options["selected_page"] == "global_options") : ?>
	...
	<fieldset class="entryfldset">
		<legend><b><?php echo t('Minimum interval between idea submissions'); ?></b></legend>
		<div>
		<input type="textbox" name="interval_between_idea_submissions" value="<?php echo $data["config"]["interval_between_idea_submissions"]; ?>" style="width:50px">
		</div>
		<span style="color:grey; font-size:x-small"><?php echo t('How many minutes an user must wait between idea submissions. Can be used to limit spam. 0 means no limitation.'); ?></span>
	</fieldset>

	<fieldset class="entryfldset">
		<legend><b><?php echo t('Minimum interval between solution submissions'); ?></b></legend>
		<div>
		<input type="textbox" name="interval_between_solution_submissions" value="<?php echo $data["config"]["interval_between_solution_submissions"]; ?>" style="width:50px">
		</div>
		<span style="color:grey; font-size:x-small"><?php echo t('How many minutes an user must wait between solution submissions. Can be used to limit spam. 0 means no limitation.'); ?></span>
	</fieldset>
