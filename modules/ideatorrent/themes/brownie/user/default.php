...
<li>
<a href="<?php echo $GLOBALS['basemodule_url'] ?>/<?php echo $GLOBALS['basemodule_path']; ?>/delete_user_comments/"><?php echo t('Delete ALL his/her comments and desactivate the user'); ?></a>
</li>
</ul>
<br />
<?php endif; ?>
